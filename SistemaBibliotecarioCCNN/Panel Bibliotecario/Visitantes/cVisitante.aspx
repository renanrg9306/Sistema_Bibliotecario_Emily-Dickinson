                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtNumero" MaxLength="8" pattern="[12345678]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
