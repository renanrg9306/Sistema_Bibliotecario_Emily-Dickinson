...
{
    public partial class RptLibroV : System.Web.UI.Page
    {
        ...
        protected void BtnCrearReportexAutor_Click(object sender, EventArgs e)
        {
            ...
            RptLibroVarios.LocalReport.ReportPath = MapPath("~/Panel Bibliotecario/Materiales/Libros/Reportes/RptLibrosxAutor.rdlc");
        ...
        protected void BtnReportexClasificacion_Click(object sender, EventArgs e)
        {
            BtnRegresar.Visible = true;
            RptLibroVarios.SizeToReportContent = true;
            RptLibroVarios.LocalReport.ReportPath = MapPath("~/Panel Bibliotecario/Materiales/Libros/Reportes/RptLiLibroxClasificacion.rdlc");
            RptLibroVarios.LocalReport.DataSources.Clear();
        ...
        protected void BtnClayAu_Click(object sender, EventArgs e)
        {
            BtnRegresar.Visible = true;
            RptLibroVarios.SizeToReportContent = true;
            RptLibroVarios.LocalReport.ReportPath = MapPath("~/Panel Bibliotecario/Materiales/Libros/Reportes/RptLibroxClayAutor.rdlc");
            RptLibroVarios.LocalReport.DataSources.Clear();
        ...
        {
            Response.Redirect("../GestionLibros_Bibliotecario.aspx");
        }
    }
}