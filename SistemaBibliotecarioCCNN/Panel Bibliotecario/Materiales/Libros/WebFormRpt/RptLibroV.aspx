<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="RptLibroV.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.Materiales.Libros.WebFormRpt.RptLibroV" %>
          ...
          <%--  <div class="col-md-1"></div>--%>
            <div class="col-md-10" style="margin-left:220px;">
                <div class="table-responsive">
                    ...
                    <rsweb:ReportViewer ID="RptLibroVarios" runat="server"></rsweb:ReportViewer>
                </div>
            </div>
            <div class="col-md-1"></div>
            </div>
