<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="RptLiABByCla_Autor_Both.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.Materiales.AudioBooks.WebFormRpt.RptLiABByCla_Autor_Both" %>
                               ...
                               <fieldset class="col-md-4">
                                   ...
                                   <div class="panel panel-default">
                                       <div class="panel-body">
                                           <div class="row">
                                           <div class=" col-md-7">                                         
                                                <asp:DropDownList ID="DdlAutor" EnableViewState="true" OnPreRender="DdlAutor_PreRender"  CssClass="form-control Selector" runat="server"></asp:DropDownList>                                             
                                           </div>
                                                 <div class="col-md-5">
          ...
          <%--  <div class="col-md-1"></div>--%>
            <div class="col-md-10" style="margin-left:180px;">
                <div class="table-responsive">
                    ...
                    <rsweb:ReportViewer ID="RptABxAutor_Cla_Both" runat="server"></rsweb:ReportViewer>
                </div>
            </div>
            <div class="col-md-1"></div>
            </div>
