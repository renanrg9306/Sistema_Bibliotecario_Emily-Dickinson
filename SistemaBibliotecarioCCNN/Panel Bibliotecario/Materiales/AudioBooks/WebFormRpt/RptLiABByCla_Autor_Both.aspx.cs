...
{
    public partial class RptLiABByCla_Autor_Both : System.Web.UI.Page
    {
        ...
        protected void BtnCrearReportexAutor_Click(object sender, EventArgs e)
        {
            ...
            RptABxAutor_Cla_Both.LocalReport.ReportPath = MapPath("~/Panel Bibliotecario/Materiales/Audiobooks/Reportes/RptABByAu_Cla.rdlc");
