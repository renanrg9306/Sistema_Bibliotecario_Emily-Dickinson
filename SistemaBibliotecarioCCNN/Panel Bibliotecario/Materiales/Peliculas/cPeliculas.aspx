<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="cPeliculas.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.Materiales.Peliculas.cPeliculas" %>
            ...
            <div class="col-md-10">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <asp:Label ID="Label1" CssClass="CamposObligatorios" runat="server" Text="(*) Campos Obligatorios"></asp:Label></div>
                    </div>
                </div>
            </div>
            <div class="col-md-1"></div>
