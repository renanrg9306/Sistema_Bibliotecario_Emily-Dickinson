<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="cPrestamoRevista.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.Prestamos.Domicilio_y_Sala.cPrestamoRevista" %>
        ...
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-heading heightheader">
                    <h3>Préstamo de Revista</h3>
                    </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="input-group">
                                 <label>Revista:<label class="AstericoColorTamanio">*</label></label>
                                <asp:DropDownList ID="DdlMaterialRevista" OnPreRender="DdlMaterialRevista_PreRender"  CssClass="form-control Selector" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                ...
                <br />
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            Display="Dynamic" ValidationGroup="FormCreatePrestamoRevista" runat="server"
                        ...
                        <div class="col-sm-3" style="margin-top:15px;">
                            <div class="form group">
                                <br />
                                <asp:Button ID="BtnGuardar" ValidationGroup="FormCreatePrestamoRevista" OnClick="BtnGuardar_Click"  CssClass="btn btn-info" runat="server" Text="Guardar" />
