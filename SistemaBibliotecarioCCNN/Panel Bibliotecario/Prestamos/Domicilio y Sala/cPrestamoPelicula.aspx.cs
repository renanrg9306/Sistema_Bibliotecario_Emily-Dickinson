    ...
    public partial class cPrestamoPelicula : System.Web.UI.Page
    {
        ...
        protected void BtnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int Existencia = oPelicula.Cantidad - oPelicula.Prestado;
                if (Existencia > 0 && oPrestamo.Cantidad <= Existencia)
                {
                    ...
                    if (PeliculaBLL.AsignarCantidadPrestaPelicula(oPelicula))
                    {
                        ...
                        if (BibliotecarioBLL.AsignarCantidadPrestamosRealizados(oBibliotecario))
                        {
                            ...
                            EnvioCorreoBLL.EnviarCorreo("Pelicula Prestado: ", "Titulo Pelicula:" + " " + oPelicula.Nombre + " Prestado por: " + BibliotecarioBLL.GetDatosBibliotByCodUsuario(Session["username"].ToString()) + " Que será devuelto: " + oPrestamo.FechaDevolucion.ToShortDateString(), oVisitante.Email);
