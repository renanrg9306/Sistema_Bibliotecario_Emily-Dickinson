...
{
    public partial class RptHistPresVi : System.Web.UI.Page
    {
        ...
        protected void BtnRptPrestamosVisitante_Click(object sender, EventArgs e)
        {
            if (Convert.ToDateTime(TxtSegundaFecha.Text) > Convert.ToDateTime(TxtPrimeraFecha.Text))
            {
                ...
                RptHisPreVi.LocalReport.ReportPath = MapPath("~/Panel Bibliotecario/Prestamos/Domicilio y Sala/RptPrestamos/RptHisPreVisitante.rdlc");
