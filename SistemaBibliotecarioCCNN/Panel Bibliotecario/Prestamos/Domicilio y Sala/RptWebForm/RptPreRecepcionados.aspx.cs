...
{
    public partial class RptPreRecepcionados : System.Web.UI.Page
    {
        ...
        protected void BtnRptRecepcionF_Click(object sender, EventArgs e)
        {
            if (Convert.ToDateTime(TxtSegundaFecha.Text) > Convert.ToDateTime(TxtPrimeraFecha.Text))
            {
                ...
                RptMaRecepcionado.LocalReport.ReportPath = MapPath("~/Panel Bibliotecario/Prestamos/Domicilio y Sala/RptPrestamos/RptMaterialRecepcionado.rdlc");
