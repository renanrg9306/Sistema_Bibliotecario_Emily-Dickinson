...
namespace SistemaBibliotecarioCCNN.Panel_Bibliotecario.Prestamos.Prorroga
{
    public partial class Prorroga : System.Web.UI.Page
    {
        ...
        protected void BtnDarProrroga_Click(object sender, EventArgs e)
        {
            try
            {
                if (oProrroga.CantidadProrroga == 1)
                {
                    if (TxtDatePickerProrroga2.Text != "")
                    {
                        ...
                        {
                            Response.Redirect("../Domicilio y Sala/GestionPrestamos_Bibliotecarios.aspx");
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "MisJs", "ErrorFecha();", true);
            }
        }
