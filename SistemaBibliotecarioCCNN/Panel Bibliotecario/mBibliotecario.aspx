<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="mBibliotecario.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.mBibliotecario" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-1">
                                ...
                                <asp:TextBox ID="TxtEdad" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                             ...
                             <div class="col-sm-2">
                               <label>Teléfono:<label class="AstericoColorTamanio">*</label></label>
                                <asp:TextBox ID="TxtTelefono" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                            ...
                            <div class="col-sm-3">
                             ...
                             <div class="col-sm-3">
                               <label>Formación:<label class="AstericoColorTamanio">*</label></label>
                                ...
                                <asp:DropDownList ID="DdlNivelAca" runat="server" CssClass="form-control" OnPreRender="DdlNivelAca_PreRender">
                                </asp:DropDownList>
                                    </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <div class="form-group">
                            <label>Formación:<label class="AstericoColorTamanio">*</label></label>
                        <asp:TextBox ID="TxtNivelAca" AutoComplete="off" onKeyPress="ucwords(this)" runat="server" CssClass="form-control"></asp:TextBox>
