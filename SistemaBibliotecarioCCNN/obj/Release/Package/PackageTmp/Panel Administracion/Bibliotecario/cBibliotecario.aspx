               ...
               <div class="row">
                   <div class="col-sm-4">
                       ...
                       <div class="input-group">
                           ...
                           <asp:TextBox ID="TxtEdad" MaxLength="2" pattern="[0-9][0-9]" AutoComplete="off" CssClass="form-control" placeholder="20" runat="server"></asp:TextBox>
                       </div>
               ...
               <div class="row">
                   ...
                   <div class="col-sm-4">
                       ...
                       <div class="input-group">
                           ...
                           <asp:TextBox ID="TxtTelefono" MaxLength="8" AutoComplete="off" CssClass="form-control" placeholder="58732329" runat="server"></asp:TextBox>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <asp:TextBox ID="TxtNivelAca" onKeyPress=" ucwords(this) ;return ValidarLetra(event);"  AutoComplete="off" onKeyPress="ucwords(this)" runat="server" CssClass="form-control"></asp:TextBox>
