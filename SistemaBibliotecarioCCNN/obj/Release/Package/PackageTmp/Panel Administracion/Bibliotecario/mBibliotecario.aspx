                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <asp:TextBox ID="TxtCedula" AutoComplete="off" onKeyPress="toUpper(this)" CssClass="form-control" runat="server"></asp:TextBox>
                                  ...
                                  <asp:RegularExpressionValidator ID="RegEx" ForeColor="OrangeRed" ValidationGroup="FormUpdateBiblio" runat="server" ErrorMessage="Formato de cédula incorrecto" ControlToValidate="TxtCedula" ValidationExpression="[0-9][0-9][0-9][-][0-9][0-9][0-9][0-9][0-9][0-9][-][0-9][0-9][0-9][0-9][A-Z]">
                             ...
                             <div class="col-sm-3">
                               <label>Correo:<label class="AstericoColorTamanio">*</label></label>
                                <asp:TextBox ID="TxtCorreo" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                     <asp:RegularExpressionValidator ID="RegErCorreo" ForeColor="OrangeRed" ValidationGroup="FormUpdateBiblio" runat="server" ErrorMessage="Correo Invalido" ControlToValidate="TxtEmail" ValidationExpression="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$">
                           </asp:RegularExpressionValidator>
