<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="GestionVisitante.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Visitantes.GestionVisitante" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript">
    function checkDelete(aElement,Prestado) {
        swal({
            ...
            if ((objConfirm.value)&& Prestado == 0) {

                $.ajax({
                    type: "POST",
                    url: "GestionVisitante.aspx/DeleteVisitante",
                    data: JSON.stringify({ IdVisitante: aElement.attributes.title.value }),
            ...
            }else if(objConfirm.value && Prestado > 0){
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Acciones">
                                <ItemTemplate>                                 
                                    ...
                                    <asp:LinkButton ID="LBtnEliminar" OnClientClick='<%# "return checkDelete(this," +Eval("Prestado") + " );" %>'  ToolTip='<%#Eval("idVisitante")%>'  runat="server" Text="<i class='fa fa-trash'></i> E" CssClass="btn btn-danger"></asp:LinkButton>
