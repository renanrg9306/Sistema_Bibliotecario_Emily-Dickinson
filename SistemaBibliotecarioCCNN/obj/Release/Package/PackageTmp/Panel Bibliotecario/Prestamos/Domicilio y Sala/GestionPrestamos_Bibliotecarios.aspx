<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="GestionPrestamos_Bibliotecarios.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.Prestamos.Domicilio_y_Sala.GestionPrestamos_Bibliotecarios" %>
        ...
        function checkRecepcionar(aElement) {
            swal({
                ...
                if (objConfirm.value) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "GestionPrestamos_Bibliotecarios.aspx/RecepcionarPrestamo",
            ...
            <div class="col-md-12" style="margin-left: 15px;">
              ...
              <div class="btn-group">
                   ...
                   <ul class="dropdown-menu" role="menu">
                       <li><a href="RptWebForm/RptPreRealizados.aspx">Listar Prestamos Realizados</a></li>
                       <li><a href="RptWebForm/RptPreRecepcionados.aspx">Listar Prestamos Recepcionados</a></li>
                       <li><a href="RptWebForm/RptHistorialPreMaterial.aspx">Listar Prestamos de un Material</a></li>
                       <li><a href="RptWebForm/RptHistPresVi.aspx">Listar Prestamos de un Visitante</a></li>
                       <li><a href="RptWebForm/RptPrestamo_Prorroga.aspx">Listar Prestamos con Prrorroga</a></li>
