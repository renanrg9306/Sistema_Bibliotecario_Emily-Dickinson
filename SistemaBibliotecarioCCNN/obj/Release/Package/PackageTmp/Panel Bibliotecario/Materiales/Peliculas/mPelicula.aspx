<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Bibliotecario/Bibliotecario.Master" AutoEventWireup="true" CodeBehind="mPelicula.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Bibliotecario.Materiales.Peliculas.mPelicula" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-primary">
                    <div class="panel-heading heightheader"><h3>Actualizar Datos de Pelicula</h3></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="input-form">
                                    <label>Titulo de la Pelicula:</label>
                                    <asp:TextBox ID="TxtMaterialNombre" Enabled="false" onKeyPress="ucwords(this)" TextMode="MultiLine" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-form">
                                    ...
                                    <asp:TextBox ID="TxtSinopsis" onKeyPress="ucwords(this)" TextMode="MultiLine" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                                <asp:RequiredFieldValidator ID="ValidarSinopsis" ControlToValidate="TxtSinopsis" ForeColor="Red"
                                    Display="Dynamic" ValidationGroup="UpdatePelicula" runat="server"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <asp:DropDownList ID="DdlProtagonista" OnPreRender="DdlProtagonista_PreRender" runat="server" CssClass="form-control"></asp:DropDownList>
                                  </div>
                              </div>
                            ...
                            <div class="col-md-4">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <asp:DropDownList ID="DdlDirector" OnPreRender="DdlDirector_PreRender" runat="server" CssClass="form-control"></asp:DropDownList>
                                  </div>
                              </div>
                            </div>
                        ...
                        <div class="row">
                             <div class="col-md-3">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <asp:DropDownList ID="DdlGenero"  OnPreRender="DdlGenero_PreRender" runat="server" CssClass="form-control"></asp:DropDownList>
                                  </div>
                              </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                  <div class="input-group">
                                      <label>Descripcion:<label class="AstericoColorTamanio">*</label></label>
                                  </div>
                                  <div class="input-group">
                                      <span class="input-group-addon"></span>
                             ...
                             <div class="col-md-2">
                                  ...
                                  <div class="input-group">
                                      <span class="input-group-addon"></span>
                                      <asp:TextBox ID="TxtCantidad" Enabled="false" AutoComplete="off" runat="server" CssClass="form-control"></asp:TextBox>
                                  </div>
                             ...
                             <div class="col-md-3 Botones">
                                  ...
                                  <div class="form-group">
                                      <asp:Button ID="BtnActualizar" ValidationGroup="UpdatePelicula" OnClick="BtnActualizar_Click" CssClass="btn btn-primary" runat="server" Text="Actualizar" />
                        ...
                        <asp:Label ID="LbIdMateialPelicula" runat="server" Visible="false" Text=""></asp:Label>
                        <asp:Label ID="LblPelicula" runat="server" Visible="false" Text=""></asp:Label>
                ...
                <div class="modal-body">
                     ...
                     <div class="form-group">
                        ...
                        <asp:TextBox ID="TxtDescripcionClasificacion" AutoComplete="off" onKeyPress="ucwords(this)" runat="server" CssClass="form-control"></asp:TextBox>
                                    ...
                                    <asp:Label ID="Label3" Font-Bold="true" runat="server" Text="(*) Campos Obligatorios"></asp:Label>
                                
                        <div class="modal-footer">
                          <%--  <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>--%>
                            <asp:Button ID="BtnClasificacion" ValidationGroup="ModalClasificacion" OnClick="BtnGuardarClasificacionAtajo_Click" CssClass="btn btn-primary" runat="server" Text="Guardar" />
                        </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <%--<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>--%>
                            <asp:Button ID="BtnGuardarProtagnistaAtajo" ValidationGroup="ModalProtagonista" OnClick="BtnGuardarProtagonista_Click" CssClass="btn btn-primary" runat="server" Text="Guardar" />
                        </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <%--<button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>--%>
                            <asp:Button ID="BtnGuardaDirectorAtajo" ValidationGroup="ModalDirector" OnClick="BtnGuardarDirector_Click" CssClass="btn btn-primary" runat="server" Text="Guardar" />
                        </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="modal-footer">
                           <%-- <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>--%>
                            <asp:Button ID="BtnGuardarGeneroAtajo" ValidationGroup="ModalGenero" OnClick="BtnGuardarGenero_Click" CssClass="btn btn-primary" runat="server" Text="Guardar" />
                        </div>
            </div>
        </div>
    </div>
