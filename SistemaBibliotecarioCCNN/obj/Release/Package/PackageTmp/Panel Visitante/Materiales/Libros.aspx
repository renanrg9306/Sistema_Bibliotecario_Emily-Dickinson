<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Visitante/Visitante.Master" AutoEventWireup="true" CodeBehind="Libros.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Visitante.Materiales.Libros" %>
            ...
            <asp:GridView ID="GdvShowLibros" runat="server" OnRowDataBound="GdvShowLibros_RowDataBound" OnPreRender="GdvShowLibros_PreRender" CssClass="table-condensed table-bordered gvdatatable" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Size="Small">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            <asp:LinkButton ID="LnkBtnReservar" CommandArgument='<%#Eval("idMaterial")%>' OnCommand="LnkBtnReservar_Command" CssClass="btn btn-sm btn-success" Text="<i class='glyphicon glyphicon-pencil'></i>R" runat="server"></asp:LinkButton>
