<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Visitante/Visitante.Master" AutoEventWireup="true" CodeBehind="GestionReservaciones.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Visitante.Materiales.GestionReservaciones" %>
            ...
            <asp:GridView ID="GdvReservacionesSinEntregar" runat="server" OnRowDataBound="GdvReservacionesSinEntregar_RowDataBound" OnPreRender="GdvReservacionesSinEntregar_PreRender" CssClass="table-condensed table-bordered gvdatatable" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Size="Small">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                                <ItemTemplate>
                                    <asp:LinkButton ID="LnkEliminar" runat="server" CommandArgument='<%#Eval("idReserva")%>' OnCommand="LnkBtnEntregar_Command" CssClass="btn btn-danger" Text="<i class='glyphicon glyphicon-pencil'></i>E"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
