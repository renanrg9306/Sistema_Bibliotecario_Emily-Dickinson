...
{
    public partial class ReportePeliculasV : System.Web.UI.Page
    {
        ...
        protected void BtnCrearReportexProtagonista_Click(object sender, EventArgs e)
        {
            ...
            RptVReportesPelicuaV.LocalReport.ReportPath = MapPath("~/Panel Administracion/Materiales/Peliculas/Reportes/RptLiPelxPro.rdlc");
        ...
        protected void BtnReportexClasificacion_Click(object sender, EventArgs e)
        {
            BtnRegresar.Visible = true;
            RptVReportesPelicuaV.SizeToReportContent = true;
            RptVReportesPelicuaV.LocalReport.ReportPath = MapPath("~/Panel Administracion/Materiales/Peliculas/Reportes/RptLiPexCla.rdlc");
            RptVReportesPelicuaV.LocalReport.DataSources.Clear();
        ...
        protected void BtnClayPro_Click(object sender, EventArgs e)
        {
            BtnRegresar.Visible = true;
            RptVReportesPelicuaV.SizeToReportContent = true;
            RptVReportesPelicuaV.LocalReport.ReportPath = MapPath("~/Panel Administracion/Materiales/Peliculas/Reportes/RptLiPexClayPro.rdlc");
            RptVReportesPelicuaV.LocalReport.DataSources.Clear();
