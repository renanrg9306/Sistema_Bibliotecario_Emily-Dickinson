<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="GestionRevista.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Materiales.Revistas.GestionRevista" %>
     ...
     function checkDelete(aElement,CantidadPrestado) {
         swal({
             ...
             if ((objConfirm.value) && CantidadPrestado == 0) {
                 ...
                 $.ajax({
                     type: "POST",
                     url: "GestionRevista.aspx/DeleteRevista",
            ...
            <div class="col-md-6" style="margin-left: 15px;">
                ...
                <div class="btn-group">
                   ...
                   <ul class="dropdown-menu" role="menu">
                       <li><a href="WebFormRpt/RptListarRevistas.aspx">Listar Todos</a></li>
                       <li><a href="WebFormRpt/RptLiRevistaDis.aspx">Listar Disponibles</a></li>
                       <li><a href="WebFormRpt/ReporteRevistaV.aspx">Listar por Autor, Clasificación</a></li>
