...
{
    public partial class ReporteRevistaV : System.Web.UI.Page
    {
        ...
        protected void BtnReportexClasificacion_Click(object sender, EventArgs e)
        {
            BtnRegresar.Visible = true;
            RptVRevistaVarios.SizeToReportContent = true;
            RptVRevistaVarios.LocalReport.ReportPath = MapPath("~/Panel Administracion/Materiales/Revistas/Reportes/RptRevistaxCla.rdlc");
            RptVRevistaVarios.LocalReport.DataSources.Clear();
        ...
        protected void BtnClayPro_Click(object sender, EventArgs e)
        {
            BtnRegresar.Visible = true;
            RptVRevistaVarios.SizeToReportContent = true;
            RptVRevistaVarios.LocalReport.ReportPath = MapPath("~/Panel Administracion/Materiales/Revistas/Reportes/RptRevistaxAuyCla.rdlc");
            RptVRevistaVarios.LocalReport.DataSources.Clear();
