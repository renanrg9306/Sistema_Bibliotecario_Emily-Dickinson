...
{
    public partial class RptListarRevistas : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                RptVListarRevistas.LocalReport.ReportPath = MapPath("~/Panel Administracion/Materiales/Revistas/Reportes/RptLiRevista.rdlc");
