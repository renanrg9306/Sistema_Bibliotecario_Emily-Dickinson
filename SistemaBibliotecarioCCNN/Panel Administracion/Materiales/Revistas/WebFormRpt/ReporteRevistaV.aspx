<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="ReporteRevistaV.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Materiales.Revistas.WebFormRpt.ReporteRevistaV" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10" style="margin-left:100px;">
                <div class="table-responsive">
                    ...
                    <rsweb:ReportViewer ID="RptVRevistaVarios" runat="server"></rsweb:ReportViewer>
                </div>
            </div>
