<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="mRevista.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Materiales.Revistas.mRevista" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                     ...
                     <div class="col-md-2">
                        ...
                        <asp:DropDownList ID="DdlCondicion" CssClass="form-control Selector" runat="server">
