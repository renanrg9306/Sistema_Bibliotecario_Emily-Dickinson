<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="GestionLibros.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Materiales.Libros.GestionLibros" %>
        ...
        function checkDelete(aElement,CantidadPrestado) {
            ...
            swal({
                ...
                if ((objConfirm.value) && CantidadPrestado==0 ) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "GestionLibros.aspx/DeleteLibro",
                ...
                <asp:LinkButton ID="LnkBtnNuevo" OnClick="LnkBtnNuevo_Click" Text="<i class='fa fa-plus'></i> Nuevo" CssClass="btn btn-primary"  runat="server"></asp:LinkButton>
                  <div class="btn-group">
                   ...
                   <ul class="dropdown-menu" role="menu">
                       <li><a href="WebFormRpt/RptListarLibros.aspx">Listar Todos</a></li>
                       <li><a href="WebFormRpt/RptLibrosDisponibles.aspx">Listar Disponibles</a></li>
                       <li><a href="WebFormRpt/ReportesLibrosV.aspx">Listar por Clasificacion, Autor</a></li>
                      <%-- <li><a href="#">Lista por RegEntrada, FechaRegistro</a></li>--%>
            ...
            <asp:GridView ID="GdvShowLibros" runat="server" OnRowDataBound="GdvShowLibros_RowDataBound" OnPreRender="GdvShowLibros_PreRender" CssClass="table-condensed table-bordered gvdatatable" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Size="Small">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            <asp:LinkButton ID="LnkBtnModificar" CommandArgument='<%#Eval("idLibro")%>' OnCommand="LnkBtnModificar_Command" CssClass="btn btn-sm btn-success" Text="<i class='glyphicon glyphicon-pencil'></i>M" runat="server"></asp:LinkButton>
                            <asp:LinkButton ID="LnkBtnEliminar" OnClientClick='<%# "return checkDelete(this," +Eval("Prestado") + " );" %>'  ToolTip='<%#Eval("idMaterial")%>' CssClass="btn btn-sm btn-danger" Text="<i class='fa fa-trash'></i>E" runat="server"></asp:LinkButton>
