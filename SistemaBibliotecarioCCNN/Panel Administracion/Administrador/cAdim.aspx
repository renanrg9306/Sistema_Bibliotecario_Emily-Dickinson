               ...
               <div class="row">
                   <div class="col-sm-4">
                       ...
                       <div class="input-group">
                           ...
                           <asp:TextBox ID="TxtEdad" AutoComplete="off" pattern="[1-9][0-9]" CssClass="form-control" MaxLength="2" placeholder="20" runat="server"></asp:TextBox>
               ...
               <div class="row">
                   ...
                   <div class="col-sm-4">
                       ...
                       <div class="input-group">
                           ...
                           <asp:TextBox ID="TxtTelefono" pattern="[12345678]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" onkeypress="return ValidarNumero(event);" MaxLength="8" AutoComplete="off" CssClass="form-control validar" placeholder="58732329" runat="server"></asp:TextBox>
