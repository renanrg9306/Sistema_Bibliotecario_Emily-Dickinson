                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                               <label>Teléfono:<label class="AstericoColorTamanio" >*</label></label>
                                <asp:TextBox ID="TxtTelefono" MaxLength="8" pattern="[12345678]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox>
