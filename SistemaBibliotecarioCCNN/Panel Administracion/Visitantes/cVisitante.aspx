<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="cVisitante.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Visitantes.cVisitante" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtNombresVisitante" AutoComplete="off" onKeyPress="ucwords(this)" CssClass="form-control" placeholder="Renan Alfredo" runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                    <asp:TextBox type="text" ID="TxtApellidosVisitante" AutoComplete="off" onKeyPress="ucwords(this)" CssClass="form-control" placeholder="Rosales Gutierrez" runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtDireccionVisitante" AutoComplete="off" onKeyPress="ucwords(this)" CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtCedulaVisitante" AutoComplete="off" onKeyPress="ucwords(this)" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtEdadVisitante" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div class="col-sm-3">          
                             ...
                             <div class="col-sm-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="DdlOcupacion" OnPreRender="DdlOcupacion_PreRender" CssClass="form-control Selector" runat="server"></asp:DropDownList>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtNumero" onkeypress="return ValidarNumero(event);" pattern="[12345678]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" AutoComplete="off" MaxLength="8" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                               <%-- <asp:RegularExpressionValidator ValidationGroup="FromCreateVisit" Display="Dynamic" ID="RgExpNumero" ValidationExpression="[12345678]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" ControlToValidate="TxtNumero" runat="server" ErrorMessage="Numero no valido"></asp:RegularExpressionValidator>--%>
                             ...
                             <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox type="text" ID="TxtCorreo" AutoComplete="off" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                             ...
                             <div class="col-sm-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="DdlProgram" OnPreRender="DdlProgram_PreRender" CssClass="form-control Selector" runat="server"></asp:DropDownList>
                                </div>
                            </div>
