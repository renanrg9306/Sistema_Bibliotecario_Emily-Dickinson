<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="mVisitante.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Visitantes.mVisitante" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <asp:TextBox ID="TxtTelefonoV" pattern="[12345678]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" MaxLength="8" onkeypress="return ValidarNumero(event);" CssClass="form-control" runat="server"></asp:TextBox>
