<%@ Page Title="" Language="C#" MasterPageFile="~/Panel Administracion/Administracion.Master" AutoEventWireup="true" CodeBehind="Prorroga.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.Prestamos.Prorroga.Prorroga" %>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3" style="margin-top: 5px;">
                                <div class="form group">
                                    <br />
                                    <asp:Button ID="BtnDarProrroga" OnClick="BtnDarProrroga_Click" CssClass="btn btn-info" runat="server" Text="Prorroga" />
