...
{
    public partial class RptListarHistorialMaterial : System.Web.UI.Page
    {
        ...
        protected void BtnRptHisPrestamoMaterial_Click(object sender, EventArgs e)
        {
            ...
            RptHistorialMaterial.LocalReport.ReportPath = MapPath("~/Panel Administracion/Prestamos/Domicilio y Sala/RptPrestamos/RptHistPreMaterial.rdlc");
