...
{
    public partial class RptPreProrroga : System.Web.UI.Page
    {
        ...
        protected void BtnRptPrestamoProrroga_Click(object sender, EventArgs e)
        {
            if (Convert.ToDateTime(TxtSegundaFecha.Text) >= Convert.ToDateTime(TxtPrimeraFecha.Text))
            {
                ...
                RptPrePro.LocalReport.ReportPath = MapPath("~/Panel Administracion/Prestamos/Domicilio y Sala/RptPrestamos/RptPrestamo_Prorroga.rdlc");
