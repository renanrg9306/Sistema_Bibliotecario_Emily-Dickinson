<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InicioSesionAdmin.aspx.cs" Inherits="SistemaBibliotecarioCCNN.Panel_Administracion.InicioSesionAdmin" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <a  href="RecuperarClaveAdmin.aspx" class="Olvidarclave">¿Has olvidado los datos de tu cuenta?</a>
                            </div>
                        </div>
                        <div class="row">
